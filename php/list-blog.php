...
if (!empty($pagina)) {
    ...
    $qnt_result_pg = 8; //Quantidade de registro por página
    $inicio = ($pagina * $qnt_result_pg) - $qnt_result_pg;

    $query_usuarios = "SELECT * FROM tb_blog ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
    ...
    $query_pg = "SELECT COUNT(id) AS num_result FROM tb_blog";
